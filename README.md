...
| | FuelPHP | ★2年9ヶ月 | メンバーに最適なレビュー可能 |
| | Laravel | 6ヶ月 | 業務で即戦力になれる |
| DB | MySQL | ★1年9ヶ月 | テーブル設計可能 |
| OS | Linux | ★3ヶ月 | 調べながらであれば作業可能 |
...
| | IaC（CloudFormation、Terraform） | ★ 1年4ヶ月 | コードによるインフラ定義〜変更反映までのIaC運用が可能。CloudFormationではテンプレートでリソースを新規構築し、コード変更による更新・改修（差分反映）を経験。Terraformでは既存（コンソール作成）リソースを import 等で管理下に取り込み、状態の整備・コード化を行った経験あり。 |
